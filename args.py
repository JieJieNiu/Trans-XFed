...
def args_parser():
    ...
    parser.add_argument('--M', type=str, default='FedAvg', help='TransFed or FedAvg')
    parser.add_argument('--E', type=int, default=250, help='number of rounds of training')
    parser.add_argument('--poc', type=bool, default=False, help='True power of choice, False random choice')
    ...
    parser.add_argument('--loss', type=str, default='WCE', help='WCE weighted cross entropy or Focal or NLL')    
